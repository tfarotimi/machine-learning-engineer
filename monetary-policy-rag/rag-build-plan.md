...
**Goal of v1:** Build a crude, end-to-end RAG over ~20 inflation/forecasting comunicados and *watch it succeed and fail*. The point is NOT a polished system — it's to hit embeddings, retrieval, and chunking as real obstacles, and to use your domain expertise to judge retrieval quality.
...
### Stage 2: Chunk
- Split each comunicado into pieces.
